...
CREATE TABLE dwh.customer_report_datamart (
    ...
    median_month_order_lead_time_days int2 NOT NULL DEFAULT 0, -- медианное время в днях от момента создания заказа до его завершения за месяц
    -- Количество дней целое значение. Если клиент не совершал заказов в течении месяца, то медианное время выполнения заказа = 0
